...
def chinese_cleaners1(text):
    ...
    phones = [phone[0] for phone in pinyin(text, style=Style.TONE3,neutral_tone_with_five=True)]
    return ' '.join(phones)
...
def chinese_cleaners2(text):
  phones = [
      p
      for phone in pinyin(text, style=Style.TONE3,neutral_tone_with_five=True)
      for p in [
...
if __name__ == '__main__':
  ...
  res = english_cleaners('this is a club test for one train.GDP')
  print(res)
